    ...
    <>
      <main className="bg-white/90 p-4 rounded-lg mx-auto lg:mx-0 sm:w-[25rem] w-fit h-fit">
        ...
        <div className="grid gap-5">
          ...
          <div className="grid gap-1">
            <label className="font-[600]">Business Location</label>
            <input
              type="text"
          ...
          <div className="grid gap-1">
            <label className="font-[600]">Business Phone</label>
            <input
              type="tel"
          ...
          <div className="grid gap-1">
            <label className="font-[600]">Business Mail</label>
            <input
              type="text"
              placeholder="Enter your Business mail adress"
              className="outline-none focus:outline-none px-2 p-1 border border-gray-200 rounded-lg"
            ></input>
          </div>

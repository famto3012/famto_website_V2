  ...
  return (
    <>
      <div className="md:flex grid sm:grid-cols-2 gap-4 my-5 md:mx-10 mx-5">
        ...
        >
          <div className="relative rounded-xl transition-transform inset-0">
            <figure
              className={`w-full${
                card4IsHovered ? "translate-x-0" : "-transition-x-full"
              }`}
            >
              <img
            ...
            <div
              className={`absolute inset-0 flex items-end ps-5 py-5 w-42 text-[28px] transition-opacity duration-300 ${
                card4IsHovered
                  ? "translate-x-full"
                  : "translate-x-0"
              }`}
            ...
            <div
              className={`absolute inset-0 flex items-start py-5 px-5 text-[18px] rounded-lg border border-gray-300 bg-white transition-opacity duration-300 ${

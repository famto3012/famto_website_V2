...
const DeliverySlides = () => {
  ...
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:flex gap-4 my-5 md:mx-10 mx-5">
      {/* Card 1 */}
      <div
        className="relative rounded-lg w-full lg:w-1/4 overflow-hidden transition-all duration-300 z-10"

    ...
    <main className="relative">
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent">
          ...
          <h1 className="text-white text-[10px] sm:text-[14px] md:text-[24px] lg:text-[32px] text-center absolute bottom-5 left-1/2 transform -translate-x-1/2">
            Famto merchant
      ...
      <section className="lg:mx-14 m-8">
        ...
        <h1 className="flex justify-end items-end mb-[3rem] text-black/50">
          *T&C applied{" "}
        </h1>
        <div>

...
const TermsAndConditions = () => {
  ...
  return (
    ...
    <div className="relative w-full">
      <figure className="h-[19rem] md:h-[70vh]">
        <img
          ...
          src="https://firebasestorage.googleapis.com/v0/b/famtowebsite.appspot.com/o/images%2Fterms.svg?alt=media&token=8473b5c0-d169-4138-bc23-b96ae099c5ad"
          alt="Terms & Condition"
        />
      </figure>
    ...
    <section className="w-full text-[13px] md:w-[90%] mx-auto px-[2rem] md:px-[3rem] ">
      ...
      <p className="mb-[1rem]">
        ...
        inability to use, the materials on this site, even if Famto team or an
      ...
      <h3 className="termHeading">License</h3>
      <p className="mb-[1rem]">
      ...
      <p className="mb-[1rem]">
        ...
        "our"), the provider of the Famto website and the services accessible
        from the Famto  website (which are collectively referred to in these
        Terms & Conditions as the "Famto Service").
      </p>
      <p>
      ...
      <h3 className="termHeading">Definitions and key terms</h3>
      <p className="mb-[1rem]">
      ...
      <ul className="list-disc ps-[1rem] md:ps-[3rem]">
        <li>
          <span className="font-[600]">Cookie:</span> Small amount of data
          generated by a website and saved by your web browser. It is used to
          identify your browser, provide analytics, and remember information
          about you such as your language preference or login information.
        </li>
        <li>
          <span className="font-[600]">Company:</span> When these terms
          mention "Company, "we," "us," or "our," it refers to Famto . Famto
          that is responsible for your information under these Terms &
          Conditions.
        </li>
        <li>
          <span className="font-[600]">Country:</span> Where Famto or the
          owners/founders of Famto are based, in this case is Famto_
        </li>
        <li>
          <span className="font-[600]">Device:</span> Any internet connected
          device such as a phone, tablet, computer or any other device that
          can be used to visit Famto and use the services.
        </li>
        <li>
          <span className="font-[600]"> Service:</span> This refers to the
          service provided by Famto as described in the relative terms (if
          available) and on this platform.
        </li>
        <li>
          <span className="font-[600]">Third-party service:</span> This refers
        ...
        <li>
          <span className="font-[600]">Website:</span> Famto site, which can
          be accessed via this URL: www.famto.in
        </li>
        <li>
          <span className="font-[600]">You:</span> A person or entity that is
          registered with Famto to use the services
        </li>
      </ul>
      {/* </p> */}

      <h3 className="termHeading">Restrictions</h3>
      <p>You agree not to, and you will not permit others to:</p>
      <ul className="list-disc ps-[1rem] md:ps-[3rem]">
        <li>
          License, sell, rent, lease, assign, distribute, transmit, host,
          outsource, disclose or otherwise commercially exploit the Famto or
        ...
        <li>
          ...
          suppliers or the licensors of the Famto.
        </li>
      </ul>

      <h3 className="termHeading">Payment</h3>
      <p>
        ...
        an order form, you must Provide Famto with a valid credit card (Visa,
        ...
        Provider. By providing Famto with your credit card number and
        associated payment information, you agree that Famto is authorized to
        verify information immediately, and subsequently invoice your account
        for all fees and charges due and payable to Famto here under and that
        no additional notice or consent is required. You agree to immediately
        notify Famto of any change in your billing address or the credit card
      ...
      <ul className="list-disc ps-[1rem] md:ps-[3rem]">
        ...
        <li>
          No contract will exist between you and Famto for the Service until
          Famto accepts your order by a confirmatory e-mail, SMS/MMS message,
      ...
      <h3 className="termHeading">Return and Refund Policy</h3>
      <p>
        Thanks for shopping at Famto. We appreciate the fact that you like to
        ...
        conditions that apply to transactions at Famto We'll be as brief as
        our attorneys will allow. The main thing to remember is that by
        placing an order or making a purchase at Famto .you agree to the terms
        along with Famto's Privacy Policy. If, for any reason, You are not
        completely satisfied with any good or service that we provide, don't
        hesitate to contact us and we will discuss any of the issues you are
        going through with our Product.and Refund Policy.
      </p>

      <h3 className="termHeading">Your Suggestions</h3>
      <p>
        Any feedback, comments, ideas, improvements or suggestions
        (collectively, "Suggestions") provided by you to Famto with respect to
        the Famto shall remain the sole and exclusive property of Famto. Famto
      ...
      <h3 className="termHeading">Your Consent</h3>
      <p>
        ...
        it's being used. By using our Famto. Registering an account, or making
        a purchase, you hereby consent to our Terms & Conditions.
      </p>

      <h3 className="termHeading">Links to Other Websites</h3>
      <p>
        These Terms & Conditions apply only to the Services. The Services may
        contain links to other websites not operated or controlled by Famto.
      ...
      <h3 className="termHeading">Cookies</h3>
      <p>
        ...
        required to enter your login details every time you visit the Famto as
      ...
      <h3 className="termHeading">Changes To Our Terms & Conditions</h3>
      <p>
        ...
        time. You do not need to specifically inform Famto when you stop using
        the service. You acknowledge and agree that if Famto disables access
        ...
        your account. If we decide to change our Terms & Conditions, we will
        post those changes on this page, and/or update the Terms & Conditions
        modification date below.
      </p>
      <h3 className="termHeading">Modification To Our Famto</h3>
      <p>
      ...
      <h3 className="termHeading">Updates To Our Famto</h3>
      <p>
        Famto may from time to time provide enhancements or improvements to
        the features/functionality of the Famto which may include patches, bug
        ...
        Famto. You agree that Famto has no obligation to (i) provide any
        Updates, or (i continue to provide or enable any particular features
        and/or functionalities of the Famto to you. You further agree that all
        Updates will be () deemed to constitute an integral part of the Famto,
        and (i) subject to the terms and conditions of this Agreement.
      </p>
      <h3 className="termHeading">Third-Party Services</h3>
      <p>
        ...
        Services"). You acknowledge and agree that Famto shall not be
        ...
        decency, quality or any other aspect thereof. Famto does not assume
        and shall not have any liability or responsibility to you or any other
      ...
      <h3 className="termHeading">Terms and Termination</h3>
      <p>
        ...
        deleting the Famto and all copies thereof from your computer. Upon
        termination of this Agreement, you shall cease all use of the Famto
        and delete all copies of the Famto from your computer. Termination of
        this Agreement will not limit any of Famto's rights or remedies at law
      ...
      <h3 className="termHeading">Copyright infringement Notice</h3>
      <p>
      ...
      <h3 className="termHeading">Indemnification</h3>
      <p>
      ...
      <p className="mb-[1rem]">
        ...
        implied, statutory or otherwise, with respect to the Famto, including
      ...
      <p className="mb-[1rem]">
        ...
        Famto nor any. Famto provider makes any representation or warranty of
        any kind, express or implied: (i) as to the operation or availability
        of the Famto,or the information, content, and materials or products
        included thereon;(ii) that the Famto will be uninterrupted or
        error-free; (iii) as to the accuracy, reliability, or currency of any
        information or content provided through the Famto or (iv) that the
        Famto, its servers, the content, or e-mails sent from or on behalf of
        Famto are free of viruses, scripts, Trojan horses, worms, malware,
        time bombs or other harmful components.
      </p>
      <p>
      ...
      <h3 className="termHeading">Limitation of Liability</h3>
      <p className="mb-[1rem]">
      ...
      <p className="mb-[1rem]">
        ...
        inability to use the Famto ,third-party software and/or third-party
        hardware used with the Famto, or otherwise in connection with any
        provision of this Agreement),even if Famto or any supplier has been
      ...
      <h3 className="termHeading">Severability</h3>
      <p className="mb-[1rem]">
      ...
      <p>
        ...
        entire agreement between you and Famto concerning the Services. If any
        ...
        or any other term, and Famto's failure to assert any right or
        provision under this Agreement shall not constitute a waiver of such
        right or provision. YOU AND Famto_AGREE THAT ANY CAUSE OF ACTION
      ...
      <h3 className="termHeading">Waiver</h3>
      <p className="mb-[1rem]">
      ...
      <h3 className="termHeading">Amendments to this agreement</h3>
      <p>
        Famto reserves the right, at its sole discretion, to modify or replace
        ...
        discretion. By continuing to access or use our Famto after any
        revisions become effective, you agree to be bound by the revised
        terms. If you do not agree to the new terms, you are no longer
        authorized to use Famto.
      </p>
      <h3 className="termHeading">EntireAgreement</h3>
      <p>
        ...
        contemporaneous written or oral agreements between you and Famto. You
        may be subject to additional terms and conditions that apply when you
        use or purchase other Famto's services, which Famto will provide to
        you at the time of such use or purchase.
      </p>
      <h3 className="termHeading">Updates to Our Terms</h3>
      <p>
      ...
      <h3 className="termHeading">Intellectual Property</h3>
      <p>
        ...
        Famto, unless and except as is expressly provided in these Terms &
        Conditions. Any unauthorized use of the material is prohibited.
      </p>
      <h3 className="termHeading">Agreement to Arbitate</h3>
      <p className="mb-[1rem]">
        ...
        REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR FAMTO'S INTELLECTUAL
        PROPERTY RIGHTS.
      </p>
      <p>
      ...
      <h3 className="termHeading">Notice to Dispute</h3>
      <p>
        ...
        your email address. You and Famto will attempt to resolve any dispute
        through informal negotiation within sixty (60) days from the date the
        Notice of Dispute is sent. After sixty (60) days, you or Famto may
        commence arbitration.
      </p>
      <h3 className="termHeading">Binding Arbitration</h3>
      <p>
      ...
      <h3 className="termHeading"> Submissions and Privacy</h3>
      <p>
        ...
        and will become the sole property of Famto without any compensation or
        credit to you whatsoever. Famto and its affiliates shall have no
      ...
      <h3 className="termHeading">Promotions</h3>
      <p>
      ...
      <h3 className="termHeading">Typographical Errors</h3>
      <p>
      ...
      <h3 className="termHeading">Miscellaneous</h3>
      <p>
        ...
        representative of Famto, Famto will be entitled to injunctive or other
        ...
        Famto operates and controls the Famto Service from its offices in
        Famto . The Service is not intended for distribution to or use by any
        person or entity in any jurisdiction or country where such
        distribution or use would be contrary to law or regulation.
        Accordingly, those persons who choose to access the Famto Service from
      ...
      <p>
        ...
        the Service. Famto reserves the right to make additions, deletions, or
        modifications to the contents on the Service at any time without prior
        notice. The Famto Service and its contents are provided "as is" and
        "as available" without any warranty or representations of any kind,
        whether express or implied. Famto is a distributor and not a publisher
        of the content supplied by third parties; as such,Famto exercises no
        ...
        accessible via the Famto Service. Without limiting the foregoing,
        Famto specifically disclaims all warranties and representations in any
        content transmitted on or in connection with the Famto Service or on
        sites that may appear as links on the Famto Service, or in the
        products provided as a part of, or otherwise in connection with, the
        Famto Service, including without limitation any warranties of
        merchantability, fitness for a particular purpose or non-infringement
        of third party rights. No oral advice or written information given by
        Famto or any of its affiliates, employees, officers,directors, agents,
        ...
        Famto does not warrant that the Famto Famto_Service will be
        uninterrupted, uncorrupted, timely, or error-free.
      </p>

      <h3 className="termHeading">Contact Us</h3>
      <p>
        ...
        <br />
        via phone:
        <a href="tel:+919778180794">
          <strong>+91 97781 80794</strong>
        </a>
        <br />
        via link:{" "}
        <strong>

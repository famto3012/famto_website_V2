  ...
  return (
    <main className="relative">
      ...
      py-[1rem] mb-[2rem] font-[400]">
        ...
        {/* <p> */}
        <ul className="list-disc ps-[1rem] md:ps-[3rem] space-y-1">
          <li>
            <span className="font-[500]">Cookie:</span> Small amount of data
          ...
          <li>
            <span className="font-[500]">Website:</span> Famto site, which can
            be accessed via this URL: www.famto.in
          </li>
          <li>
            <span className="font-[500]">You:</span> A person or entity that is

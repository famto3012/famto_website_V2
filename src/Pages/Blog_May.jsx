...
const Blog_May = () => {
  ...
  return (
    <main className="relative">
      ...
      <section className="w-full text-[13px] md:text-[16px] mx-auto px-[2rem] md:px-[3rem] py-[1rem] mb-[2rem]">
        <Link to="/blogs">
          <div className="text-black flex items-center justify-start my-2 underline">
            <IoMdArrowBack /> Back
          </div>
        </Link>

  ...
  return (
    ...
    <div className="relative w-full">
      <figure className="h-[10rem] md:h-[70vh]">
        <img className="w-full h-full object-cover" src="https://firebasestorage.googleapis.com/v0/b/famto-admin-panel.appspot.com/o/Famto%20website%20assets%2Ffaq.svg?alt=media&token=82573efe-719a-4a99-a387-8a34a50e58c2" alt="FAQ" />
      </figure>
    ...
    <section
      className="w-full md:w-[90%] mx-auto px-[1rem] md:px-[3rem]
    py-[3rem]"
    >
      <div
